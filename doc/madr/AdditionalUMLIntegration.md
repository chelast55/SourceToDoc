...
- [clangUML](https://clang-uml.github.io/) (utilizing [PlantUML](https://plantuml.com/)) can be used to generate additional UML diagrams (to the ones generated by doxygen's dot tool ([graphviz](https://graphviz.org/)) implementation)
