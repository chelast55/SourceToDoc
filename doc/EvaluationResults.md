...
|:-----------------------------------------|--------------|--------------------:|-----------------------:|-------------------------:|----------------------:|------------------------------:|--------------------------------:|------------------------:|:--------------:|:---------:|:---------:|:--------:|:--------------:|:-------------------:|:----------:|---------------------------------------------------------------|
| C++ Best Practices Template (meson port) | meson        |                 0.1 |  (seems incorrect) 177 |                        2 |                  0.70 |        (seems incorrect) 8.59 |                            0.32 |                       - |                |   PASS    |   PASS    |   FAIL   |      PASS      |                     |            |                                                               |
| CMake tutorial (step 5)                  | cmake        |                 0.0 |                      1 |                        2 |                  0.64 |                          0.09 |                            0.16 |                    3.67 |                |   PASS    |   PASS    |   PASS   |      PASS      |                     |            |                                                               |
| FOX toolkit (meson fork)                 | meson        |                28.4 |                    515 |                     2320 |                     - |                         14.57 |                               - |                       - |                |   PASS    |   PASS    |   FAIL   |      FAIL      | no runtimes with TC |            | Linking failed (utf-8 decode error), but report was generated |
| ImGui                                    | -            |                99.5 |                    119 |                     1620 |                     - |                          4.10 |                         1357.06 |                    0.40 |                |   FAIL    |   PASS    |   PASS   | FAIL (w. conv) |                     |            |                                                               |
| libavtp                                  | meson        |                 0.5 |                     11 |                       27 |                  0.61 |                          0.29 |                            4.20 |                    6.90 |                |   PASS    |   PASS    |   PASS   |      PASS      |                     |            |                                                               |
| libuv (cmake port)                       | cmake        |                21.0 |                     95 |                     1690 |                     - |                          2.37 |                          299.16 |                       - |                |   FAIL    |   PASS    |   FAIL   | FAIL (w. conv) |                     |            |                                                               |
| meson bootstrap demo                     | meson        |                 0.0 |                      1 |                        1 |                  0.02 |                          9.09 |                            0.17 |                    5.32 |                |   PASS    |   PASS    |   PASS   |      PASS      |                     |            |                                                               |
| Phosphor Power Monitor                   | meson        |                 0.0 |                      1 |                        1 |                  0.22 |                          0.08 |                            0.11 |                       - |                |   PASS    |   PASS    |   FAIL   |      PASS      |                     |            |                                                               |
| WOTPP macro language                     | meson        |                 1.0 |                     10 |                       24 |                  4.38 |                          0.45 |                            2.80 |                       - |                |   PASS    |   PASS    |   FAIL   |      FAIL      |                     |            |                                                               |
